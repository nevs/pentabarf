<?php
  ...
  if (!isset($OPTIONS[0])) {
    ...
    // conference schedule
    require_once("html3-conference-schedule.php");
    exit;
    ...
    if (isset($OPTIONS[1]) && $OPTIONS[1] == "images" && isset($OPTIONS[2])) {
      ...
      require_once("html3-conference-event.php");
    }
  } else if (substr($OPTIONS[0],0,6) == "events") {
      // event index
      require_once("html3-conference-event-index.php");
      exit;
    ...
    if (isset($OPTIONS[1]) && $OPTIONS[1] == "images" && isset($OPTIONS[2])) {
      ...
      require_once("html3-conference-speaker.php");
    }
  } else if (substr($OPTIONS[0],0,8) == "speakers") {
    // speaker index
    require_once("html3-conference-speaker-index.php");
    exit;
