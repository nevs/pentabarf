...
/**
 * Class for accessing, manipulating, creating and deleting records in event_origin.
*/

class Event_Origin extends Entity
{

  public function __construct($select = array())
  {
    $this->table = "event_origin";
    $this->order = "";
    $this->domain = "valuelist";
    $this->field['event_origin_id']['type'] = 'SERIAL';
