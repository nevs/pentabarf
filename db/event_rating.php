...
class Event_Rating extends Entity
{
  ...
  public function __construct($select = array())
  {
    ...
    $this->field['quality']['type'] = 'SMALLINT';
    $this->field['quality_comment']['type'] = 'VARCHAR';
    $this->field['quality_comment']['length'] = 128;
    $this->field['documentation']['type'] = 'SMALLINT';
    $this->field['documentation_comment']['type'] = 'VARCHAR';
    $this->field['documentation_comment']['length'] = 128;
