module FormTestHelper
  ...
  class Form
    ...
    def submit(opts={})
      raise MissingSubmitError, "Submit button not found in form" unless tag.select('input[type="submit"], input[type="image"], button[type="submit"], button[id="submit-button"]').any?
      @xhr = opts.delete(:xhr)
