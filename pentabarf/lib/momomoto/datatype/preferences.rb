  ...
  module Datatype
    ...
    class Preferences < Base 
      ...
      def filter_read( value )
        ...
        value[:search_event_last] = 0 unless value[:search_event_last] > 0
        ...
        value[:search_person_last] = 0 unless value[:search_person_last] > 0
        ...
        value[:search_conference_last] = 0 unless value[:search_conference_last] > 0
