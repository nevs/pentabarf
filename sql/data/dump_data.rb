...
tables = [:country, :currency, :language, :language_localized, :conference_phase, :conference_phase_localized, :event_origin, :event_state, :event_state_progress, :event_role, :event_role_state, :event_type]
schema = 'public'
