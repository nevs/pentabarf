...
SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('mime_type', 'mime_type_id'), 19, true);


--
-- Data for Name: mime_type; Type: TABLE DATA; Schema: public; Owner: pentabarf
--
