...
--
-- Name: phone_type_phone_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pentabarf
--

SELECT pg_catalog.setval(pg_catalog.pg_get_serial_sequence('phone_type', 'phone_type_id'), 8, true);


--
-- Data for Name: phone_type; Type: TABLE DATA; Schema: public; Owner: pentabarf
--
