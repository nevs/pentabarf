CREATE OR REPLACE VIEW release.view_schedule_event AS
  SELECT event.event_id,
    ...
    FROM release.event
         ...
         INNER JOIN release.view_schedule_room USING(conference_release_id, conference_id)
         INNER JOIN release.view_schedule_day USING(conference_release_id, conference_id)
