...
CREATE INDEX log.phone_type_localized_phone_type_idx ON log.phone_type_localized( phone_type );
CREATE INDEX log.phone_type_localized_log_transaction_id_idx ON log.phone_type_localized( log_transaction_id );
