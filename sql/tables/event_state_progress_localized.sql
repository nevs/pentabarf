...
CREATE INDEX log.event_state_progress_localized_event_state_event_state_progress_idx ON log.event_state_progress_localized( event_state, event_state_progress );
CREATE INDEX log.event_state_progress_localized_log_transaction_id_idx ON log.event_state_progress_localized( log_transaction_id );
