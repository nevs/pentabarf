...
CREATE TABLE person_travel (
  ...
  FOREIGN KEY (arrival_transport_id) REFERENCES transport (transport_id) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (departure_transport_id) REFERENCES transport (transport_id) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (travel_currency_id) REFERENCES currency (currency_id) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (accommodation_currency_id) REFERENCES currency (currency_id) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (fee_currency_id) REFERENCES currency (currency_id) ON UPDATE CASCADE ON DELETE CASCADE,
