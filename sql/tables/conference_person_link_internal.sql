...
CREATE INDEX log_conference_person_link_internal_conference_person_link_internal_id_idx ON log.conference_person_link_internal( conference_person_link_internal_id );
