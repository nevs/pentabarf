...
CREATE INDEX log.event_role_state_event_role_event_role_state_idx ON log.event_role_state( event_role, event_role_state );
CREATE INDEX log.event_role_state_log_transaction_id_idx ON log.event_role_state( log_transaction_id );
