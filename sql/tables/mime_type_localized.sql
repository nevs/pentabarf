...
CREATE INDEX log.mime_type_localized_mime_type_idx ON log.mime_type_localized( mime_type );
CREATE INDEX log.mime_type_localized_log_transaction_id_idx ON log.mime_type_localized( log_transaction_id );
