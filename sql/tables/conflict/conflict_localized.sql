...
CREATE INDEX log.conflict_localized_conflict_idx ON log.conflict_localized( conflict );
CREATE INDEX log.conflict_localized_log_transaction_id_idx ON log.conflict_localized( log_transaction_id );
