...
CREATE INDEX log.conflict_type_conflict_type_idx ON log.conflict_type( conflict_type );
CREATE INDEX log.conflict_type_log_transaction_id_idx ON log.conflict_type( log_transaction_id );
