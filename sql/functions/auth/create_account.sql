...
CREATE OR REPLACE FUNCTION auth.create_account( p_login_name TEXT, p_email TEXT, p_password TEXT, p_activation_string CHAR(64), p_conference_id INTEGER) RETURNS INTEGER AS $$
  DECLARE
