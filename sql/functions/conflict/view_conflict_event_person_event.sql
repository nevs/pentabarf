...
CREATE OR REPLACE FUNCTION view_conflict_event_person_event( conference_id INTEGER ) RETURNS SETOF view_conflict_event_person_event AS $$
  SELECT conflict_event_person_event.conflict_id, 
