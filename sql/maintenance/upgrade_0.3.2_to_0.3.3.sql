...
ALTER TABLE event_person ADD CONSTRAINT event_person_event_role_fkey FOREIGN KEY( event_role ) REFERENCES event_role(event_role) ON UPDATE CASCADE ON DELETE CASCADE;
