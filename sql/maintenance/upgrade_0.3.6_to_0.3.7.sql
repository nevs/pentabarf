...
INSERT INTO conference_day(conference_id,conference_day,public) SELECT conference_id, start_date + generate_series(0,days - 1), true FROM conference ORDER BY 1,2;
