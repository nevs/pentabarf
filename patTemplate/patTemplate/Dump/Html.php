 ...
 *
 * $Id: Html.php,v 1.16 2004/06/03 19:23:52 schst Exp $
 *
 * @package		patTemplate
 * @subpackage	Dump
...
class patTemplate_Dump_Html extends patTemplate_Dump
{
	...
	*/
	...
	function _displayAttributes( $tmpl )
	{
		...
		switch( $tmpl['attributes']['type'] )
		{
			...
			case 'simplecondition':
				...
				$this->_displayLine( 'RequiredVars', implode( ', ', $tmpl['attributes']['requiredvars'] ) );
