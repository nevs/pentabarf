...
class Jabber
{
  ...
  private $log_filehandler;

  private $iq_sleep_timer;
  private $last_ping_time;

  private $packet_queue;
  private $subscription_queue;

  private $iq_version_name;
  private $iq_version_os;
  private $iq_version_version;

  private $error_codes;

  private $connected;
  private $keep_alive_id;
  private $returned_keep_alive;
  private $txnid;
