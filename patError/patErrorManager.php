 ...
 *
 *	$Id: patErrorManager.php,v 1.4 2004/04/06 20:46:00 gerd Exp $
 *
 * @package	patError
 */
 ...
 * @todo	replace is_a with PHP function (allow patErrorManager to work with PHP < 4.2)
 */
	...
	*/
    function &raise( $level, $code, $msg, $info = null )
    {
		...
		switch( $handling['mode'] )
		{
			...
			// print debugging information for developing purpose
			case 'verbose':
	...
	*/
    function addIgnore( $codes )
    {
		...
		foreach( $codes as $code )
		{
			if( !in_array( $code, $GLOBALS['_pat_errorIgnores'] ) )
			{
				array_push( $GLOBALS['_pat_errorIgnores'], $code );
			}
		}
		*/
